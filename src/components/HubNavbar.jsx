      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 md:px-12 py-4 flex items-center justify-between bg-neutral-950/80 backdrop-blur-md border-b border-neutral-800">
        ...
        <div className="flex items-center gap-6">
          <div className="relative">
            ...
            {showNotifications && (
                <div className="fixed left-1/2 top-20 -translate-x-1/2 w-[90vw] sm:absolute sm:right-0 sm:top-full sm:mt-2 sm:translate-x-0 sm:w-80 bg-neutral-900 border border-neutral-800 rounded-lg shadow-xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2">
          ...
          <div className="relative group">
            <div className="flex items-center gap-3 cursor-pointer">
                ...
                <div className="w-10 h-10 bg-neutral-800 rounded-full overflow-hidden border border-neutral-700">
                    <img src={`https://api.dicebear.com/7.x/notionists/svg?seed=${user?.email || 'user'}`} alt="avatar" />
                </div>
            </div>
