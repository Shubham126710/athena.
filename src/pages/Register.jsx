    ...
    <div className="min-h-screen bg-neutral-950 text-white font-sans flex">
      ...
      <div className="hidden lg:block w-1/2 relative overflow-hidden border-r border-neutral-800">
        ...
        <div className="absolute inset-0 flex flex-col p-12 z-10 pointer-events-none">
            <div className="flex items-center gap-2 pointer-events-auto cursor-pointer hover:opacity-80 transition-opacity mb-12" onClick={() => nav('/')}>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                    <div className="flex items-start gap-4">
                        <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white font-bold text-sm backdrop-blur-sm">1</div>
                        <div className="backdrop-blur-sm bg-black/20 p-2 rounded-lg">
                            <h3 className="font-bold text-white">Personalized Timetable</h3>
                            <p className="text-neutral-400 text-sm">Automatically synced with your section's schedule.</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white font-bold text-sm backdrop-blur-sm">2</div>
                        <div className="backdrop-blur-sm bg-black/20 p-2 rounded-lg">
                            <h3 className="font-bold text-white">Smart Attendance</h3>
                            <p className="text-neutral-400 text-sm">Track your attendance and get alerts before you fall behind.</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white font-bold text-sm backdrop-blur-sm">3</div>
                        <div className="backdrop-blur-sm bg-black/20 p-2 rounded-lg">
                            <h3 className="font-bold text-white">Resource Hub</h3>
                            <p className="text-neutral-400 text-sm">Access notes, previous year papers, and study materials.</p>
                        </div>
                    </div>
                </div>
            </div>
      ...
      {/* Right Side - Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 overflow-y-auto relative bg-neutral-950">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <ConstellationBackground />
        </div>
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none"></div>
        
        <div className="w-full max-w-md space-y-8 my-auto animate-in fade-in slide-in-from-bottom-8 duration-1000 relative z-10">
